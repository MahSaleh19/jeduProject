...
<head>
    <meta charset="utf-8">
    <title>إدارة الاستثمار والشراكات - إمانة جدة</title>
...
<!-- Navbar start -->
<div class="container-fluid sticky-top px-0"  dir="rtl">
            ...
            <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                <div class="top-info flex-grow-0">
                    ...
                    <div class="pe-2 me-3 border-end border-white d-flex align-items-center">
                        <p class="mb-0 text-white fs-6 fw-normal">أخبار عاجلة</p>
                    </div>
...
{{--                            <img src="img/features-fashion.jpg"
                            ...
                            <span class="rounded-circle btn-sm-square bg-primary me-2"
                                  style="width: 30px; height: 30px;" ><i class="fas fa-bolt text-white"></i></span>
                            <a href="#" style="padding:0 20px 0 20px;"><p class="text-white mb-0 link-hover">
                                    تعليم جدة يكرّم 30 موهوباً وموهوبةً تأهلوا لنهائيات إبداع 2024
                                </p></a>
                            <span class="rounded-circle btn-sm-square bg-primary me-2"
                                  style="width: 30px; height: 30px; " ><i class="fas fa-bolt text-white"></i></span>
                            <a href="#" style="padding:0 20px 0 20px;"><p class="text-white mb-0 link-hover">
                                    تعليم جدة ينظم لقاء الاستخدام الأمثل للمضادات الحيوية
                                </p></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light navbar-expand-xl">
                <a href="/" class="navbar-brand mt-3">
                    <p class="text-primary display-6 mb-2" style="line-height: 0;">إدارة الاستثمار والشركات</p>
{{--                    <small class="text-body fw-normal" >أمانة جدة</small>--}}
                </a>
                ...
                <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                    <div class="navbar-nav mx-auto border-top">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">الفرص الاستثمارة</a>
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="#" class="dropdown-item">مباني</a>
                                <a href="#" class="dropdown-item">أراضي فضاء</a>
                            </div>
                        </div>
...
{{--                        <a href="404.html" class="nav-item nav-link">404 Page</a>--}}
                        ...
                        <a href="contact.html" class="nav-item nav-link">حجز موعد</a>
                    </div>
...
<div class="container-fluid populer-news py-0" dir="rtl">
    <div class="container py-5">
        <div class="tab-class mb-4">
            <div class="row g-4">
                <div class="col-lg-8 col-xl-9">
                    <div class="d-flex flex-column flex-md-row justify-content-md-between border-bottom mb-4">
                        <h3 class="mb-4">الفرص الاستثمارية</h3>
                        <ul class="nav nav-pills d-inline-flex text-center">
                            <li class="nav-item mb-3">
                                <a class="d-flex py-2 bg-light rounded-pill active me-2" data-bs-toggle="pill" href="#tab-1">
                                    <span class="text-white" style="width: 100px;">مرافق تعليميه</span>
                                </a>
                            </li>
                            <li class="nav-item mb-3">
                                <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" href="#tab-2">
                                    <span class="text-dark" style="width: 100px;">مباني</span>
                                </a>
                            </li>
                            <li class="nav-item mb-3">
                                <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" href="#tab-3">
                                    <span class="text-dark" style="width: 100px;">أرض فضاء</span>
                                </a>
                            </li>
{{--                            <li class="nav-item mb-3">--}}
...
{{--                            </li>--}}
                    ...
                    <div class="border-bottom mb-4" dir="ltr">
                        <h2 class="my-4">Most Views News</h2>
                    </div>
                    <div class="whats-carousel owl-carousel" dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="p-3 rounded border">
                                <h4 class="mb-4">لمزيد من التواصل</h4>
                                <div class="row g-4">
